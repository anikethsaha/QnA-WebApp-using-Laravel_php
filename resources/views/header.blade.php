        ...
        <div class="ask-que-form">
              <form class="" action="/submit/ask/question" method="post">
                ...
                <label for="">Explain your problem in detail</label>
                  ...
                  <input type="hidden" name="user_email" value="{{ encrypt($user->email) }}">
                  <input type="hidden" name="user_id" value="{{ encrypt($user->id) }}">
                  <input type="radio" required  name="user_name" style="width:5%;" value="{{ encrypt($user->name) }}"> Your Original User Name<br>
                  <input type="radio" required name="user_name" style="width:5%;" value="{{ encrypt($user->anonymous_name) }}"> Anonymous Name<br>
          ...
          <div class="circle" ></div>
         			<div class="menu">
         				<ul>
         					...
         					<li><a href=
                     @if(Session::get('username')!="guest" && Session::has('username'))
                    ...
                    >Write A Post</a>
         					...
         					<li>
                    <a href= @if(Session::get('username')!="guest"  && Session::get('username')!="wrong password" && Session::get('username')!="wrong username" && Session::has('username'))
                      {{ url('/profile/my')}}
                    @else
                      <?php echo "/user"; ?>
